      ...
      <div className="ml-0 lg:ml-72 flex flex-col min-h-screen">
        ...
        <main className="p-4 lg:p-8 flex-1 max-w-7xl w-full mx-auto pb-28">
          ...
          <nav className="flex items-center gap-2 text-xs text-slate-400 mb-3">
            ...
            <span className="text-indigo-600 font-semibold">Browsing History</span>
          </nav>
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 p-4 mb-8 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
            {/* View Mode Tabs */}
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="bg-slate-50 text-xs pl-8 pr-3 py-2 rounded-xl border border-slate-200 focus:outline-none focus:border-indigo-400 text-slate-800 w-44"
                  />
                </div>
              </div>
            )}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                      {products.map((product) => {
                        ...
                        return (
                          <div
                            key={product.id}
                            className="group bg-white rounded-3xl border border-slate-200/80 hover:border-indigo-300 p-5 flex flex-col justify-between shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative"
                          >
                            {/* Top Badges & Controls */}
                            ...
                            <div
                              ...
                              className="w-full h-40 bg-slate-50/80 rounded-2xl p-4 flex items-center justify-center mb-3 border border-slate-100 overflow-hidden cursor-pointer select-none"
                            >
                              <img
                                src={product.image}
                                alt={product.name}
                            ...
                            <div>
                              ...
                              <h3
                                ...
                                className="font-bold text-xs text-slate-900 leading-snug truncate group-hover:text-indigo-600 transition cursor-pointer"
                              >
                                {product.name}
                              </h3>
                  ...
                  <div className="divide-y divide-slate-100">
                    {recentSearches.map((item, idx) => (
                      <div
                        ...
                        className="py-3.5 flex items-center justify-between hover:bg-indigo-50/40 px-3 rounded-2xl transition cursor-pointer group"
                      >
                        <div className="flex items-center gap-3.5 min-w-0">
                          <div className="w-10 h-10 rounded-xl bg-slate-100 group-hover:bg-indigo-600 group-hover:text-white flex items-center justify-center text-slate-500 text-sm transition">
                            <FiSearch />
                          </div>
                          <div>
                        ...
                        <div className="flex items-center gap-3">
                          <button
                            ...
                            className="px-3 py-1.5 bg-indigo-50 text-indigo-700 group-hover:bg-indigo-600 group-hover:text-white font-bold text-xs rounded-xl transition flex items-center gap-1 cursor-pointer"
                          >
                            <span>Re-search</span>
          ...
          <div className="mt-8 bg-gradient-to-r from-indigo-50/60 via-purple-50/40 to-blue-50/60 border border-indigo-100/60 rounded-3xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
            ...
            <button
              onClick={clearAllHistory}
              className="px-4 py-2 bg-white border border-slate-200 hover:border-rose-300 text-rose-600 font-bold text-xs rounded-xl shadow-xs transition shrink-0 cursor-pointer flex items-center gap-1.5"
            >
              <FiTrash2 className="text-xs" />
