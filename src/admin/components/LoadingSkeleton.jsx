...
export function TableSkeleton({ rows = 5, columns = 6 }) {
  return (
    <div className="w-full bg-white rounded-2xl border border-slate-200 p-4 shadow-sm animate-pulse">
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 animate-pulse">
      {Array.from({ length: 6 }).map((_, i) => (
        <div key={i} className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm flex flex-col justify-between h-32">
...
export function ChartsSkeleton() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-pulse">
      <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 p-5 h-80 flex flex-col justify-between">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-5 h-80 flex flex-col justify-between">
...
export function DetailsSkeleton() {
  return (
    <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm animate-pulse space-y-6">
