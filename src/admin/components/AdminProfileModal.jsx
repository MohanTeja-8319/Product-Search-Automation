...
export function AdminProfileModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Card */}
      <div className="relative bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 z-10 animate-scaleUp overflow-hidden">
          ...
          <div className="mt-6 flex items-center justify-between pt-4 border-t border-slate-100">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-3 py-1.5 text-xs font-semibold text-indigo-600 bg-indigo-50 hover:bg-indigo-100 rounded-xl transition-colors"
              >
                Edit Profile
              </button>
              <button
