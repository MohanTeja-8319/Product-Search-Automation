  ...
  const columns = [
    {
      ...
      width: "w-20",
      render: (item) => (
        <div className="w-12 h-12 rounded-xl bg-slate-100 p-1 border border-slate-200 flex-shrink-0 flex items-center justify-center overflow-hidden">
          <img
            src={item.image}
            alt={item.name}
    ...
    },
    {
      ...
      align: "center",
      render: (item) => (
        <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg bg-amber-50 text-amber-800 font-bold text-xs border border-amber-200/60">
