    ...
    <div className="space-y-6">
      ...
      {errorJobModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <div className="relative bg-white rounded-2xl max-w-lg w-full p-6 z-10 shadow-2xl border border-slate-200 animate-scaleUp">
            ...
            <div className="mt-4 space-y-3 text-xs">
              ...
              <div>
                ...
                <div className="p-3 bg-rose-50 text-rose-800 rounded-xl border border-rose-100 font-mono text-[11px] leading-relaxed">
            ...
            <div className="mt-6 flex justify-end gap-2 pt-3 border-t border-slate-100">
              ...
              <button
                type="button"
                onClick={() => setErrorJobModal(null)}
                className="px-4 py-1.5 text-xs font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-xl"
              >
                Close
              </button>
            </div>
